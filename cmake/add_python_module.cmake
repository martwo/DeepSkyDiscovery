...
function(add_python_module _NAME _ADD_LIB_LIST)
    ...
    if(PYTHON_ENABLE_MODULE_${_NAME})
        ...
        # Copy the built python module into the python package directory
        ...
        add_custom_command(TARGET build_python_package
            POST_BUILD
            COMMAND cp ${${_NAME}_LIBOUTDIR}/${_NAME}${PYTHON_MODULE_EXTENSION} ${CMAKE_BINARY_DIR}/python/deepskydiscovery
